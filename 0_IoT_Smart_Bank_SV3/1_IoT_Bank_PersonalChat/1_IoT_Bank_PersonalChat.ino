...
#define BOTtoken "7044798614:AAHByrgbONshaSCrgOXWogERZSZjj_gTL9w"  // your Bot Token (Get from Botfather)

// Use @myidbot to find out the chat ID of an individual or a group
// Also note that you need to click "start" on a bot before it can
// message you
#define CHAT_ID "7007157760"
//"-1002085707801"
#ifdef ESP8266
...
//Telegram 
  ...
  //digitalWrite(laser, HIGH);
  //displayTemp();
  bot.sendMessage(CHAT_ID, "Hello everyone,This is IoT Bot", "");
}
